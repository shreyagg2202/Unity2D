...
public class Chessman : MonoBehaviour
{
    ...
    //References for all the sprites that the chess pieces can be
    public Sprite black_queen, black_knight, black_bishop, black_pawn, black_rook, black_king;
    public Sprite white_queen, white_knight, white_bishop, white_pawn, white_rook, white_king;
